...
// const ChatContainer = () => {
//   const { messages, selectedUser, setSelectedUser, sendMessage, getMessages, socket } = useContext(ChatContext)
//   const { authUser, onlineUsers } = useContext(AuthContext)
//   const scrollEnd = useRef()
//   const [input, setInput] = useState('')
...
//   // ✅ FIX 1: Fetch messages when user changes
//   useEffect(() => {
//     if (selectedUser?._id) {
//       getMessages(selectedUser._id)
//     }
...
//   // ✅ FIX 2: Listen for new real-time messages via socket
//   useEffect(() => {
//     if (!socket) return
...
//   // ✅ FIX 3: Scroll to bottom when new messages arrive
//   useEffect(() => {
...
//   // ✅ FIX 4: Ensure chat area shows for selectedUser
//   if (!selectedUser) {
//     return (
//       <div className="flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden">
//         <img src={assets.logo_icon} className="max-w-16" alt="" />
